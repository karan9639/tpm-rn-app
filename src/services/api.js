...
/* Also export a web-style userAPI wrapper for parity */
...
/* =========================
   WEB-PARITY WRAPPERS & ALIASES
   (so calls like maintenanceAPI.sendAcknowledgement() or
    sparePartsAPI.getAvailableParts() work in RN too)
========================= */
...
/* function aliases (used by some screens) */
...
export const send_acknowledgement = (payload) =>
  send_maintenance_acknowledgement(payload);
/* optional alias for assignment to match web naming */
